...
public class RSACoder {  
    ...
    public static Map<String,Object> initKey() throws Exception{    
        ...
        // 得到私钥字符串
        System.out.println("公钥   "+publicKeyString+ "     系数："+publicKey.getModulus()+"  加密指数："+publicKey.getPublicExponent());
        //甲方私钥    
        RSAPrivateKey privateKey=(RSAPrivateKey) keyPair.getPrivate();
        String privateKeyString = new String(Base64.encodeBase64((privateKey.getEncoded())));
        System.out.println("私钥  "+privateKeyString+ "     系数："+privateKey.getModulus()+"解密指数："+privateKey.getPrivateExponent());
        //将密钥存储在map中    
    ...
    public static void main(String[] args) throws Exception {    
        ...
        System.out.println("甲方 使用乙方公钥加密后的数据："+Base64.encodeBase64(code1));
